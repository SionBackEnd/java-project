...
public class YoutubeSub {
    ...
    public static void main(String[] args) {
        ...
        String userId;
        String userPassword;
        System.out.print("[시스템] 유튜브 계정의 아이디를 입력하세요 {Hint - admin} : ");
        userId = s.nextLine();
        System.out.print("[시스템] 유튜브 계정의 비밀번호를 입력하세요{Hint - 0000} : ");
        ...
        //금칙어 배열 생성
        String[] swear = new String[]{"킹", "시발", "꺼져", "미친"};
        System.out.println("=============================");
        System.out.println("[알림] 프로그램의 금칙어 리스트입니다.");
        System.out.println(Arrays.toString(swear));
        System.out.println("==============================");
        ...
        //대체어 배열 생성
        String[] replaceWords = new String[]{"열", "사랑", "용기", "희망"};

        // 금지어가 있을시 금칙어를 대체어로 변환
